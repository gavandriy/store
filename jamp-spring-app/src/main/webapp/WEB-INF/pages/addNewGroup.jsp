...
<body>
	...
	<div id="content">
		<form:form action="${pageContext.request.contextPath}/groups/add/"
			...
			<form:label path="mentor">Mentor</form:label>
			<form:select path="mentor" >
				<form:options items="${mentors}"  itemValue="id"   itemLabel="assignee.fullName" />
			</form:select>
			<form:hidden path="phase.id" />
			<form:label path="mentee">Mentee</form:label>
			<form:select path="mentee" >
				<form:options items="${mentees}"  itemValue="id"   itemLabel="assignee.fullName" />
			</form:select>

			<form:label path="plannedStart">Planned Start Date [yyyy-MM-dd]</form:label>
			<form:input path="plannedStart"></form:input>

			<form:label path="plannedEnd">Planned End Date [yyyy-MM-dd]</form:label>
			<form:input path="plannedEnd" ></form:input>
